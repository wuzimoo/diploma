...
class ObjectAssignment(Base, TimestampMixin):
    ...
    role_on_object: Mapped[str] = mapped_column(String(120), default="Mitarbeiter")
...
class Crew(Base, TimestampMixin):
    ...
    specialization: Mapped[str] = mapped_column(String(160), default="Allgemeine Bauarbeiten")
...
class CrewMember(Base, TimestampMixin):
    ...
    employee_id: Mapped[int] = mapped_column(ForeignKey("employees.id"))
    role_in_crew: Mapped[str] = mapped_column(String(120), default="Mitarbeiter")
